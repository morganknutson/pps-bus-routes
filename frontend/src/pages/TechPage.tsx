              ...
              <SectionContent>
                <div style={{ backgroundColor: 'var(--bg-secondary)', padding: '15px', borderRadius: '8px', marginBottom: '15px' }}>
                  ...
                  <ul>
                    ...
                    <li><strong>Caching</strong> - To save costs and improve speed, committed cache seeds live in <code>data/cache/</code>. Production writes new runtime cache entries to <code>runtime-data/cache/</code> via <code>RUNTIME_DATA_DIR</code>, keeping the deployment checkout clean for webhook pulls.</li>
                  </ul>
                </div>
              </SectionContent>
            </div>
            ...
            <div id="deployment" style={{ marginBottom: '40px', scrollMarginTop: '80px' }}>
              ...
              <SectionContent>
                <div style={{ backgroundColor: 'var(--bg-secondary)', padding: '15px', borderRadius: '8px', marginBottom: '15px' }}>
                  ...
                  <ul>
                    <li><strong>GitHub Webhook</strong> - Pushes to <code>main</code> trigger makserve to pull the production checkout and rebuild the container.</li>
                    <li><strong>Runtime Data</strong> - The production container mounts <code>data/</code> read-only and writes live caches/job history to ignored <code>runtime-data/</code>, so generated route data can be deployed from git without local checkout conflicts.</li>
                    <li><strong>Environment</strong> - Process management and restarts are handled by the hosting platform (e.g., Docker restart policies + health checks).</li>
                  </ul>
                </div>
              </SectionContent>
            </div>
              ...
              <SectionContent>
                <div style={{ backgroundColor: 'var(--bg-secondary)', padding: '15px', borderRadius: '8px', marginBottom: '15px' }}>
                  ...
                  <ul>
                    ...
                    <li><strong>/data</strong> - The committed JSON database, route PDFs, processed routes, and cache seeds generated by the synchronization workflow.</li>
                    <li><strong>/runtime-data</strong> - Ignored production runtime cache and job history files, mounted writable while <code>/data</code> remains read-only.</li>
                  </ul>
                </div>
              </SectionContent>
            </div>
            ...
            <div id="maintenance" style={{ marginBottom: '40px', scrollMarginTop: '80px' }}>
              ...
              <SectionContent>
                <div style={{ backgroundColor: 'var(--bg-secondary)', padding: '15px', borderRadius: '8px', marginBottom: '15px' }}>
                  <strong style={{ color: 'var(--text-primary)' }}>Process Detail:</strong>
                  <ul>
                    <li><strong>SchedulerService</strong> - Manages Google Drive sync and PDF reprocessing in the data synchronization environment.</li>
                    <li><strong>Production Jobs</strong> - Background synchronization is disabled in production unless <code>ENABLE_WEEKLY_SYNC=true</code>; production should serve the latest committed generated data and avoid mutating tracked files.</li>
                    <li><strong>Job Queue</strong> - A persistent queue system that handles long-running geocoding and parsing tasks in the background, with job history stored under the configured runtime data directory.</li>
                  </ul>
                </div>
              </SectionContent>
            </div>
