...
const StaticModal = ({ children, maxWidth = '345px' }: { children: React.ReactNode, maxWidth?: string }) => (
  <Modal isOpen={true} onClose={() => {}} maxWidth={maxWidth} static>
    {children}
  </Modal>
);
...
export function DesignSystemPage() {
  ...
  const [directionFilter, setDirectionFilter] = useState<'Morning' | 'Afternoon' | 'Both'>('Morning');
  const [buttonAlignment, setButtonAlignment] = useState<'left' | 'center'>('left');
  const [buttonWidthMode, setButtonWidthMode] = useState<'hug' | 'fill'>('hug');
    ...
    <>
      ...
      <section id="buttons" style={{ marginBottom: '6rem', scrollMarginTop: '100px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '4rem' }}>
          {/* Dynamic Matrix */}
          <div>
            <h3 style={{ fontSize: '1.2rem', fontWeight: '600', marginBottom: '1.5rem', color: 'var(--text-primary)' }}>Interactive Matrix</h3>
            <div style={{
              display: 'grid',
              ...
              {/* Header */}
              <div />
              <div style={{ textAlign: 'center', fontSize: '0.8rem', fontWeight: '700', color: 'var(--text-tertiary)', textTransform: 'uppercase' }}>Large</div>
              <div style={{ textAlign: 'center', fontSize: '0.8rem', fontWeight: '700', color: 'var(--text-tertiary)', textTransform: 'uppercase' }}>Medium</div>
              <div style={{ textAlign: 'center', fontSize: '0.8rem', fontWeight: '700', color: 'var(--text-tertiary)', textTransform: 'uppercase' }}>Small</div>

              {/* Primary Row */}
              <div style={{ fontSize: '0.9rem', fontWeight: '600', color: 'var(--text-secondary)' }}>Primary</div>
              <div style={{ display: 'flex', justifyContent: 'center' }}>
                <Button
                  variant="primary"
                  size="large"
                  align={buttonAlignment}
                  fullWidth={buttonWidthMode === 'fill'}
                  icon={showButtonIcon ? "fas fa-bus" : undefined}
              ...
              {/* Secondary Row */}
              <div style={{ fontSize: '0.9rem', fontWeight: '600', color: 'var(--text-secondary)' }}>Secondary</div>
              <div style={{ display: 'flex', justifyContent: 'center' }}>
                <Button
                  variant="secondary"
                  size="large"
                  align={buttonAlignment}
                  fullWidth={buttonWidthMode === 'fill'}
                  icon={showButtonIcon ? "fas fa-school" : undefined}
                  showChevron={showButtonChevron || showButtonDropdown}
                  chevronDirection={showButtonDropdown ? 'down' : 'right'}
                  disabled={isButtonDisabled}
                >
              ...
              {/* Tertiary Row */}
              <div style={{ fontSize: '0.9rem', fontWeight: '600', color: 'var(--text-secondary)' }}>Tertiary</div>
              <div style={{ display: 'flex', justifyContent: 'center' }}>
                <Button
                  variant="tertiary"
                  size="large"
                  align={buttonAlignment}
                  fullWidth={buttonWidthMode === 'fill'}
                  icon={showButtonIcon ? "fas fa-map-marker-alt" : undefined}
                  showChevron={showButtonChevron || showButtonDropdown}
                  chevronDirection={showButtonDropdown ? 'down' : 'right'}
                  disabled={isButtonDisabled}
                >
      ...
      <section id="controls" style={{ marginBottom: '6rem', scrollMarginTop: '100px' }}>
        ...
        <div style={{ marginTop: '2rem' }}>
          <h3 style={{ fontSize: '1rem', fontWeight: '500', marginBottom: '1rem' }}>DirectionToggle</h3>
          <div style={{ padding: '2rem', backgroundColor: 'var(--bg-secondary)', borderRadius: '12px' }}>
      ...
      <section id="modals" style={{ marginBottom: '6rem', scrollMarginTop: '100px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(350px, 1fr))', gap: '2rem', marginBottom: '4rem' }}>
          <div>
            ...
            <div style={{ padding: '2rem', backgroundColor: 'var(--modal-backdrop)', backdropFilter: 'blur(8px)', borderRadius: '12px', display: 'flex', justifyContent: 'center' }}>
              <StaticModal>
                <Modal.Header icon={<RouteIcon size={24} color="var(--text-primary)" />}>
                ...
                <Modal.Footer><Button variant="primary" fullWidth size="large">Understood</Button></Modal.Footer>
              </StaticModal>
            </div>
          </div>
          <div>
            ...
            <div style={{ padding: '2rem', backgroundColor: 'var(--modal-backdrop)', backdropFilter: 'blur(8px)', borderRadius: '12px', display: 'flex', justifyContent: 'center' }}>
              <StaticModal>
                ...
                <Modal.Footer><Button variant="primary" fullWidth size="large">Okay</Button></Modal.Footer>
              </StaticModal>
            </div>
          </div>
        </div>
