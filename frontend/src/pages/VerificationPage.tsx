        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: isMobile ? '0.5rem' : '1rem', flexWrap: 'wrap', width: isMobile ? '100%' : 'auto', alignItems: 'center' }}>
            ...
            <button
              ...
              style={{
                padding: isMobile ? '0.5rem 1rem' : '0.75rem 1.5rem',
                backgroundColor: fetchingAll ? 'var(--bg-secondary)' : 'var(--text-primary)',
                color: fetchingAll ? 'var(--text-secondary)' : 'var(--bg-primary)',
                border: 'none',
                borderRadius: '999px',
                        ...
                        return (
                          <div key={result.schoolId} style={{
                            ...
                            <button
                              ...
                              style={{
                                padding: '0.5rem',
                                backgroundColor: (fetching[result.schoolId] || isJobActive) ? 'var(--bg-secondary)' : 'var(--text-primary)',
                                color: (fetching[result.schoolId] || isJobActive) ? 'var(--text-secondary)' : 'var(--bg-primary)',
                                border: 'none',
                                borderRadius: '999px',
                            ...
                            {fetchMsg && (
                              <div style={{
                                fontSize: '9px',
                                color: fetchMsg.type === 'error' ? '#f44' : fetchMsg.type === 'success' ? '#2ecc71' : 'var(--text-secondary)',
                                marginTop: '0.5rem',
                              }}>
                              ...
                              return (
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', alignItems: 'center' }}>
                                  <button
                                    ...
                                    style={{
                                      padding: '0.5rem 1rem',
                                      backgroundColor: (fetching[school.schoolId] || isJobActive) ? 'var(--bg-secondary)' : 'var(--text-primary)',
                                      color: (fetching[school.schoolId] || isJobActive) ? 'var(--text-secondary)' : 'var(--bg-primary)',
                                      border: 'none',
                                      borderRadius: '999px',
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', marginTop: '0.75rem' }}>
                    {hasDriveLink && (
                      <button
                        ...
                        style={{
                          padding: '0.5rem',
                          backgroundColor: (fetching[school.schoolId] || isJobActive) ? 'var(--bg-primary)' : 'var(--text-primary)',
                          color: (fetching[school.schoolId] || isJobActive) ? 'var(--text-secondary)' : 'var(--bg-primary)',
                          border: 'none',
                          borderRadius: '999px',
                          cursor: (fetching[school.schoolId] || isJobActive) ? 'not-allowed' : 'pointer',
